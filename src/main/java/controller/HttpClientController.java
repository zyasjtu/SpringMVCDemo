...
public class HttpClientController {
    ...
    public String from() throws IOException {
        ...
        params.put("param1", "1");
        params.put("param2", "2");
        Map<String, Object> returnMap = httpClientService.doPost("http://127.0.0.1:8080/SpringMVCDemo/to.json", params);
    ...
    public String to(@RequestParam String param1, @RequestParam Integer param2) {
        ...
        returnMap.put("param3", param1);
        returnMap.put("param4", param2);
        return JSON.toJSONString(returnMap);
    }
}
